...
# [fit] Chrome Development Tool vs IPython

![inline left](images/document_url.png)![inline right](images/ipython_node2.png)

1. 스샷 찍기가 귀찮았고 스샷을 찍지 않아도 소스를 예쁘게 보여주면서 코드 단위로 할 수 있다면 훨씬 편할 것이라 생각해서
2. 일일이 소스 코드 복붙하기 귀찮아서..
3. 취향 나름이니 자기가 좋아하는걸 선택하시길..
-->
...
- print\_problem\_source, print\_index_phps 설명(ppt 만드는 시간이 꽤 많이 든다. 40시간 정도 쓴듯.)
